...
from model_pytorch import CrossSourceModel, SupervisedContrastiveLossV2
import time
...
dir_name = dir_+"/OUR-V2_%s_%s"%(first_prefix, method)
...
scl = SupervisedContrastiveLossV2()
...
for epoch in range(EPOCHS):
    ...
    for x_batch_f, y_batch_f in dataloader_train_f:
        ...
        loss_contra = scl( emb_scl , y_scl, temperature=temp)
