...
from model_pytorch import SupervisedContrastiveLoss, CrossSourceModelGRLv5
import time
...
model = CrossSourceModelGRLv5(input_channel_first=first_data.shape[1], input_channel_second=second_data.shape[1],  num_classes=n_classes, f_encoder=first_enc, s_encoder=second_enc)
