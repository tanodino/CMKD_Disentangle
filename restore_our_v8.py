...
from model_pytorch import CrossSourceModelGRLv8
...
folder_name_f = dir_+"/OUR-v8_%s_%s"%(first_prefix, method)
folder_name_s = dir_+"/OUR-v8_%s_%s"%(seocnd_prefix, method)
...
model = CrossSourceModelGRLv8(input_channel_first=first_data.shape[1], input_channel_second=second_data.shape[1], f_encoder=first_enc, s_encoder=second_enc)
