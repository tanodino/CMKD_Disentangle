...
from model_pytorch import CrossSourceModelGRLv2, SupervisedContrastiveLoss, CrossSourceModelGRL
import time
...
for epoch in range(EPOCHS):
    ...
    #    x_batch_s, y_batch_s = next(iteration_dataloader_train_s)
        ...
        loss_pred = nn.functional.cross_entropy(tot_pred, torch.cat([y_batch_f, y_batch_s], weight=rescaling)
        ...
        loss = loss_pred + loss_pred_dom  + loss_contra_sel # + loss_adv_dann # + loss_contra_cl #+ loss_adv_dann#
