...
from model_pytorch import CrossSourceModelGRLv5
...
folder_name_f = dir_+"/OUR-v7_%s_%s"%(first_prefix, method)
folder_name_s = dir_+"/OUR-v7_%s_%s"%(seocnd_prefix, method)
...
model = CrossSourceModelGRLv5(input_channel_first=first_data.shape[1], input_channel_second=second_data.shape[1], f_encoder=first_enc, s_encoder=second_enc)
